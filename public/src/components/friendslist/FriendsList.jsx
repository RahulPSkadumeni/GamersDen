    ...
    <div>
      <ul className="friendlistClass">
        {/* <li className="rigthBarFollowing">
          ...
          <li className="rigthBarFollowing">
            <div className="rightBarProfileImageContainer">
              <img  className='rightbarprofileImage' src="https://1.bp.blogspot.com/-sBTuXg4Hgq0/X-4HdGObKNI/AAAAAAAAjBE/YfAVrkYBtPAaKrK-n-szfKKdVi8vWJCKwCLcBGAsYHQ/s640/games%2Bdp%2B%252831%2529.jpg" alt="" />
             
              
            </div>
            <div className='rigthBarFriendCardData'>
  
            <span className='rigbtbarUsername'> Sanjay Shaji</span>
